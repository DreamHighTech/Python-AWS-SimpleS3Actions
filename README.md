List all buckets, create a S3 bucket and delete the created bucket.
===============================================================================================
...
4.	Make sure you have installed **Python** https://www.python.org/downloads/ . This code assumes that you will e installing version 2.x
